...
В случае корректности введенных данных, программа выведет сообщение об успешной замене и закроется через 1 секунду, в противном случае будет выведено сообщение об ошибке и закроется через 5 секунд. В случаче установленных параметров, дота запустится автоматически.
